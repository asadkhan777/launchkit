...
export default async function CoursePage({ params }: { params: Params }) {
  const course = await prisma.course.findFirst({ where: { slug: params.slug }, include: { lessons: true } })
  ...
  return (
    <main className="mx-auto max-w-3xl p-8">
      ...
      <p className="mt-4 text-sm text-neutral-500">Checkout integration placeholder.</p>
      <Link className="mt-6 inline-block text-blue-600 hover:underline" href="/">Back to home</Link>
    </main>
  )
}
